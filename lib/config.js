...
var ConnectionConfig, ReaderConfig, _, _ref,
  __slice = [].slice,
...
ConnectionConfig = (function() {
  ...
  ConnectionConfig.prototype.isAddressList = function(option, value) {
    var isAddr;
