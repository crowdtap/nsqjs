...
var ConnectionConfig, ConnectionState, EventEmitter, FrameBuffer, Message, NSQDConnection, NodeState, SnappyStream, StateChangeLogger, UnsnappyStream, WriterConnectionState, WriterNSQDConnection, fs, net, os, tls, version, wire, zlib, _, _ref, _ref1,
...
ConnectionState = (function(_super) {
  ...
  ConnectionState.prototype.log = function(message) {
    var _ref1;
    return StateChangeLogger.log('NSQDConnection', this.current_state_name, (_ref1 = this.conn) != null ? _ref1.id : void 0, message);
  };
  ...
  ConnectionState.prototype.states = {
    ...
    AUTH: {
      Enter: function() {
        ...
        return this.conn.write(wire.auth(this.conn.config.authSecret));
      }
    },
    AUTH_RESPONSE: {
      response: function(data) {
